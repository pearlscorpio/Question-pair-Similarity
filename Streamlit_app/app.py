...
if button:
    if prediction == 1:
        st.markdown("<h3 style='color: red;'>Questions Pair is Duplicate</h3>", unsafe_allow_html=True)
    else:
        st.markdown("<h3 style='color: green;'>Questions Pair is Not Duplicate</h3>", unsafe_allow_html=True)
